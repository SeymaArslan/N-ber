...
open class BasicAudioController: NSObject, AVAudioPlayerDelegate {
  ...
  open func stopAnyOngoingPlaying() {  // see that stops any ongoing auidoPlay if exist or if there is something playing an audio message, this function will come and stop it and also will set all these cells initial position on our audioMessages
    guard
